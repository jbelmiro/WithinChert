...
They are mainly composed of cryptocrystalline quartz (SiO2), and small peaks of aluminium. Small peaks of magnesium were also identified, and calcite was identified in a single sample. In this sample, calcite represents the only identified inclusions, which seem to show varied shapes, which may be skeletal remains.

Skeletal remains are rare, occurring in a single sample. These are composed of calcium, phosphorus, and also show an associated smaller peak of sulphur. These fossils also frequently show some oxidation, due to the associated presence of iron bands or restricted areas within the skeletal remains (@fig-m24-1). These skeletal remains are frequently irregular and indeterminate.

Finally, iron oxides are present in 3 of 4 of the samples, with an iron (Fe) composition, but also iron and sulphur or iron and titanium (@fig-m24-4). Although characterized by irregular iron inclusions, iron is also found in framboids. Of the 4 samples, 3 show the presence of spherical framboids, as well as dispersed nanocrystals (in association with spherical framboids; @fig-m24-1-m24-2).
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M24_1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M24_4_map1.png"))

```

```{r}
#| label: fig-m24-1-m24-2
#| fig-cap: "A) detailed view of iron inclusions (x1.8k magnification), possibly originally spherical pyrite framboids (black arrow) and dispersed pyrite nanocrystals (white arrow). B) detail of an irregular inclusion (x2.1k magnification) composed mainly of iron (1) and inclusions composed of iron, possibly originally dispersed pyrite nanocrystals (2). Dot represents the location of the measured spectrum plotted in graph 1 and 2. Geological sample SP69_MAR from the UJW formation."

knitr::include_graphics(here::here("figures/within-chert/SOM/M24_1_M24_2_graphs.png"))
...
They are mainly composed of cryptocrystalline quartz (predominantly silica or SiO2), and small and large peaks of aluminium. Small peaks of chlorine and potassium can also be identified.
...
Iron oxides are present in more than 90% of the samples, with an iron (Fe) composition (@fig-m12-5-s1). Other types of iron oxides are also present in lesser frequencies, such as equally large peaks of iron and titanium (20% of the samples; @fig-m12-5-s1) and titanium with a small peak of iron (20%; @fig-m7-3). EDS results also show a small subset of samples with a small peak of calcium frequently associated with iron inclusions (@fig-m12-3-mp1) and inclusions which are mainly composed of large peaks of potassium, aluminium, and magnesium and small peaks of iron or iron with titanium (@fig-m12-1-s2). Most of these inclusions have irregular shapes and varying sizes, although framboids are also present.
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M8_2_map1_spectra1_graph.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M12_5_s1_s3_graph.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M7_3_map2.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M12_3_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M12_1_s2_s3.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M12_5_spectra6_graph.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M8_1_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M12_3_spectra3.png"))
...
They are mainly composed of cryptocrystalline quartz (predominantly silica or SiO2), and large peaks of aluminium, with smaller peaks of aluminium being present in a small number of samples (n=3). Small peaks of potassium can also be identified.
...
Iron oxides are present in all samples, presenting mainly an iron (Fe) composition, and less commonly associated with small titanium (n=2; @fig-m6-1-mp1) and sulphur (n=4) peaks (@fig-m10-3-mp1). A single sample shows an inclusion composed of titanium with a small peak of iron (@fig-m10-4-s1).
...
Spherical pyrite framboids are present in 20% of the samples (n=2) and are composed of iron or iron with sulphur (@fig-m10-1-mp1).
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M6_2_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M6_1_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M10_3_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M10_4_spectra1_graph.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M6_3_map1_spectra1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M10_2_map1.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M10_6_map2.png"))
...
knitr::include_graphics(here::here("figures/within-chert/SOM/M10_1_map1.png"))
