...
Chert samples from various sources and types, including both geological and archaeological specimens, were scanned (Table 1). After scanning, the thickness and diameter of the scanned face were measured to ensure that each sample met the minimum required thickness and size [@newlanderEmpiricalStudyEffect2015; Online resource 2].
