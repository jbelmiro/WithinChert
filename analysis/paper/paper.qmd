...
M18_7 <- read_csv('data/sem_data/M18_7.csv')
M18_8 <- read_csv('data/sem_data/M18_8.csv')
M4_3 <- read_csv('data/sem_data/M4_3.csv')
...
M18_8_graph <- filtered_M18_8 |> 
  ...
  geom_label(data = peaks_M18_8, aes(x = Energy, y = Counts, label = Element, colour = Element), size = 3, fill = "white", label.size = 0.2, vjust = -0.5, show.legend = FALSE) +
...
M18_7_graph <- filtered_M18_7 |> 
  ...
  geom_label(data = peaks_M18_7, aes(x = Energy, y = Counts, label = Element, colour = Element), size = 3, fill = "white", label.size = 0.2, vjust = -0.5, show.legend = FALSE) +
  theme(legend.position="none")
...
M4_3_graph <- filtered_M4_3 |> 
  ...
  geom_label(data = peaks_M4_3, aes(x = Energy, y = Counts, label = Element, colour = Element), size = 3, fill = "white", label.size = 0.2, vjust = -0.5, show.legend = FALSE) +
  theme(legend.position="none")
...
M18_7_M18_8_fig <- magick::image_read(here::here("figures/within-chert/M18_7_M18_8.png"))
M18_7_M18_8_gg <- cowplot::ggdraw() + cowplot::draw_image(M18_7_M18_8_fig)

M18_7_M18_8_plots <- plot_grid(M18_7_graph, M18_8_graph, labels = c(1, 2))

plot_grid(M18_7_M18_8_gg, M18_7_M18_8_plots, ncol = 1, rel_heights = c(1, 1))
