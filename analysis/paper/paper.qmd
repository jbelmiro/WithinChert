...
keywords: |
  Geoarchaeology; XRD; SEM-EDS; pXRF
---
...
#ggsave("xrd_15.png", bg = "white", width = 7, height = 5, unit ="in", dpi = 300, path = "analysis")
...
grid_plot <- plot_grid(sp58_plot, sp69_plot, labels = c("a", "b"), nrow = 2)

#ggsave("grid_plot.png", bg = "white", width = 7, height = 8, unit ="in", dpi = 300, path = "analysis")
...
#ggsave("succ_barplot.png", bg = "white", width = 6, height = 4, unit ="in", dpi = 300, path = "analysis")
...
pxrf_boxplots <- ggarrange(si_boxplot, ca_boxplot, fe_boxplot, ti_boxplot, labels = c("a","b","c","d"), ncol = 2, nrow = 2, common.legend = TRUE, legend = "bottom")

#ggsave("pxrf_boxplots.png", bg = "white", width = 7, height = 7, unit ="in", dpi = 300, path = "analysis")
...
pca_plots <- plot_grid(biplot_alg, biplot_nl, biplot_comp, biplot_comp2, labels = c("a", "b", "c", "d"))

#ggsave("pca_plots.png", bg = "white", width = 9, height = 7, unit ="in", dpi = 300, path = "analysis")
