...
Other geological samples included in the study were the central Portugal (Rio Maior region) cherts from the Cretaceous formation (hereon CPT; @matiasRawMaterialSourcing2016), previously prospected and collected by previous researchers [@pereirab_presenting_2016], and the southern Portugal cherts from the Upper Jurassic of the Betic systems [@rodriguezPrehistoricFlintExploitations2011] (hereon UCA), obtained from the lithotheque of the Unit of Geoarchaeology and Archaeometry Applied to Historic Artistic and Monumental Heritage (University of Cadiz).
