...
xrd_marks <- read_csv('analysis/data/raw_data/xrd_data/xrd_peaks.csv') # File with peak data and d spacing for plot labels

# Read individual xrd files
sp15_xrd <- read_csv('analysis/data/raw_data/xrd_data/SP15_xrd.csv')
sp58_xrd <- read_csv('analysis/data/raw_data/xrd_data/SP58_xrd.csv')
sp69_xrd <- read_csv('analysis/data/raw_data/xrd_data/SP69_xrd.csv')
...
pxrf_raw <- read_csv('analysis/data/raw_data/pxrf_data/pxrf_data_dec.csv')
...
# Read table
tbl_samples <- read_csv('analysis/data/raw_data/geochem_samples_n.csv')
...
# Read table
xrd_results_tbl <- read_csv('analysis/data/raw_data/xrd_results.csv')
# Turn NAs into empty strings
